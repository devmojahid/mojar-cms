...
!(function (t) {
                    ...
                    (a && a.transitioning) ||
                        (d &&
                            d
                                ...
                                .not(o)
                                .addClass("collapsed"),
                        o[r.hasClass("in") ? "addClass" : "removeClass"](
                            "collapsed"
                        )),
                        e.call(r, l);
                }
        ...
        function e(e) {
            (e && 3 === e.which) ||
                ...
                t(o).each(function () {
                    ...
                    n.hasClass("open") &&
                        (n.trigger((e = t.Event("hide.bs.dropdown", o))),
                        e.isDefaultPrevented() ||
                            n
                                .removeClass("open")
            ...
            (s.prototype.keydown = function (e) {
                if (/(38|40|27)/.test(e.keyCode)) {
                    ...
                    if (
                        ...
                        if (!r || (r && 27 == e.keyCode))
                            return (
                                27 == e.which && s.find(o).trigger("focus"),
                                n.trigger("click")
                            );
    ...
    (function (t) {
        ...
        (e.VERSION = "3.2.0"),
            ...
            (e.prototype.init = function (e, i, n) {
                ...
                for (
                    var o = this.options.trigger.split(" "), s = o.length;
                    s--;
            ...
            (e.prototype.show = function () {
                ...
                if (this.hasContent() && this.enabled) {
                    ...
                    if (l) {
                        ...
                        (r =
                            "bottom" == r &&
                            c.top + c.height + u - f.scroll > f.height
                                ? "top"
                                : "top" == r && c.top - f.scroll - u < 0
                                ? "bottom"
                                : "right" == r && c.right + d > f.width
                                ? "left"
                                : "left" == r && c.left - d < f.left
                                ? "right"
                                : r),
                    ...
                    t.support.transition && this.$tip.hasClass("fade")
                        ? o.one("bsTransitionEnd", m).emulateTransitionEnd(150)
                        : m();
                }
            }),
            (e.prototype.applyPlacement = function (e, i) {
                ...
                var u = d.left ? 2 * d.left - o + l : 2 * d.top - s + c,
                    h = d.left ? "left" : "top",
            ...
            (e.prototype.getViewportAdjustedDelta = function (t, e, i, n) {
                ...
                if (/right|left/.test(t)) {
                    ...
                    c < r.left
                        ? (o.left = r.left - c)
                        : d > r.width && (o.left = r.left + r.width - d);
                }
                return o;
            }),
    ...
    (function (t) {
        ...
        (e.VERSION = "3.2.0"),
            ...
            (e.prototype.tip = function () {
                return (
                    this.$tip || (this.$tip = t(this.options.template)),
                    this.$tip
                );
            });
        var i = t.fn.popover;
    ...
    (function (t) {
        ...
        (i.VERSION = "3.2.0"),
            ...
            (i.prototype.activate = function (e, i, n) {
                ...
                r ? s.one("bsTransitionEnd", o).emulateTransitionEnd(150) : o(),
                    s.removeClass("in");
            });
        var n = t.fn.tab;
        (t.fn.tab = e),
        ...
        (i.VERSION = "3.2.0"),
            ...
            (i.prototype.checkPosition = function () {
                if (this.$element.is(":visible")) {
                    ...
                    var l =
                        !(null != this.unpin && n + this.unpin <= o.top) &&
                        ...
                        this.$element.trigger(d),
                            d.isDefaultPrevented() ||
                                ...
                                this.$element
                                    ...
                                    .addClass(c)
                                    .trigger(
                                        t.Event(c.replace("affix", "affixed"))
                                    ),
                                "bottom" == l &&
                                    this.$element.offset({
        ...
        (e = function () {
            ...
            for (
                (t = {}).shouldDiscardEvent = {},
                    ...
                    t.getAttribute = function (t, e) {
                        return t.getAttribute("data-" + e) || t.getAttribute(e);
                    },
                    t.reset = function (t, e) {
                        var i, n, o, s, r, a;
                        for (o in (null == e && (e = document.documentElement),
                        l))
                            if ((i = null != (a = l[o]) ? a.bindings : void 0))
                                for (n = 0, s = i.length; n < s; n++)
                                    (r = i[n]).teardown && r.teardown();
                        return (
                            (l = {}), (P = t), ((M = e).bindingId = C = 1), this
                        );
                    },
                    t.bind = function (e, i) {
                        return (
                            null == e && (e = M),
                            null == i && (i = t.context(e)),
                            o(i, e, h(e), !0)
                        );
                    },
                    t.afterBound = function (t) {
                        return r ? r.push(t) : t();
                    },
                    o = function (e, i, n, l) {
                        var d,
                        ...
                        if (
                            ...
                            (y = t.getAttribute(i, "define-array")))
                        ) {
                            for (S in ((j = a(i, e, y)),
                            null == n && (n = {}),
                            n))
                                (B = n[S]), j.hasOwnProperty(S) || (j[S] = B);
                            (n = j), (($ = c(i)).indexes = n);
                        }
                        for (
                            h = null, _ = 0, E = (q = i.attributes).length;
                            _ < E;
                            _++
                        )
                            (H = (d = q[_]).name),
                        ...
                        for (
                            (M = t.getAttribute(i, "context")) &&
                                ...
                                g = r,
                                A = 0,
                                D = (U = i.children || []).length;
                            A < D;
                            A++
                        )
                            (m = U[A]), o(e, m, null != M ? null : n);
                        for (
                            t.count = C, I = 0, O = (z = g || []).length;
                            I < O;
                            I++
                        )
                            (0, z[I])();
                    ...
                    c = function (t) {
                        var e;
                        return (
                            null == t.bindingId && (t.bindingId = ++C),
                            null != l[(e = t.bindingId)] ? l[e] : (l[e] = {})
                        );
                    },
                    t.refresh = function (e) {
                        if ((e && E.push(e), !D))
                            return (
                                (D = !0), setTimeout(t.refreshImmediately, 0)
                            );
                    },
                    k = function (t) {
                        var e, i, n, o;
                        if (t.bindings)
                            for (e = 0, i = (o = t.bindings).length; e < i; e++)
                                null != (n = o[e]).refresh && n.refresh();
                    },
                    t.refreshImmediately = function () {
                        var t, e, i, n, o;
                        for (n in ((D = !1), l)) (e = l[n]), k(e);
                        for (t = E, E = [], i = 0, o = t.length; i < o; i++)
                            (0, t[i])();
                    },
                    t.register = function (t, e) {
                        if (O[t])
                            throw new Error(
                                "Twine error: '" +
                                    t +
                                    "' is already registered with Twine"
                            );
                        return (O[t] = e);
                    },
                    ...
                    t.unbind = function (e) {
                        var i, n, o, s, r, a, c, d, u, h;
                        if ((o = e.bindingId)) {
                            if ((i = null != (u = l[o]) ? u.bindings : void 0))
                                for (s = 0, a = i.length; s < a; s++)
                                    (d = i[s]).teardown && d.teardown();
                            delete l[o], delete e.bindingId;
                        }
                        for (
                            r = 0, c = (h = e.children || []).length;
                            r < c;
                            r++
                        )
                            (n = h[r]), t.unbind(n);
                    ...
                    t.childContext = function (t) {
                        return u(t, !0);
                    },
                    u = function (t, e) {
                        for (var i, n, o; t; ) {
                            if (t === M) return P;
                            if ((e || (t = t.parentNode), !t))
                                return (
                                    console.warn(
                                        "Unable to find context; please check that the node is attached to the DOM that Twine has bound, or that bindings have been initiated on this node's DOM"
                                    ),
                                    null
                                );
                            if (
                    ...
                    h = function (t) {
                        for (var e, i; t; ) {
                            if ((e = t.bindingId))
                                return null != (i = l[e]) ? i.indexes : void 0;
                            t = t.parentNode;
                        }
                    },
                    t.contextKey = function (t, e) {
                        var i, n, o, s, r;
                        for (
                            s = [],
                                i = function (t) {
                            ...
                            (o = t.bindingId) &&
                                (n =
                                    null != (r = l[o])
                                        ...
                                        : void 0) &&
                                i(n);
                        return t === M && i(P), s.join(".");
                    },
                    R = function (t) {
                        var e, i;
                        return "input" === (e = t.nodeName.toLowerCase()) ||
                            "textarea" === e ||
                            "select" === e
                            ? "checkbox" === (i = t.getAttribute("type")) ||
                              "radio" === i
                                ? "checked"
                                : "value"
                            : "textContent";
                    ...
                    b = function (t, e) {
                        var i, n, o, s, r, a, l;
                        for (
                            s = [], n = o = 0, r = (a = e.split(".")).length;
                            o < r;
                            n = ++o
                        )
                            if (-1 !== (l = (e = a[n]).indexOf("[")))
                                for (
                                    0 === n
                                        ? s.push.apply(s, y(e.substr(0, l), t))
                                        : s.push(e.substr(0, l)),
                                        e = e.substr(l);
                                    -1 !== (i = e.indexOf("]"));

                                )
                                    s.push(parseInt(e.substr(1, i), 10)),
                                        (e = e.substr(i + 1));
                            else 0 === n ? s.push.apply(s, y(e, t)) : s.push(e);
                        return s;
                    },
                    y = function (t, e) {
                        var i, n, o;
                    ...
                    L = function (t, e, n) {
                        ...
                        for (
                            ...
                            t = null != t[(r = e[s])] ? t[r] : (t[r] = {});
                        return (t[a] = n);
                    },
                    N = function (t) {
                        return [].map
                            .call(t.attributes, function (t) {
                                return t.name + "=" + JSON.stringify(t.value);
                            })
                            .join(" ");
                    },
                    U = function (t, e, i) {
                        ...
                        (t = "return " + t),
                            x(i) && (t = "with($arrayPointers) { " + t + " }"),
                            I(e) && (t = "with($registry) { " + t + " }");
                        try {
                            return new Function(
                                e,
                                "with($context) { " + t + " }"
                            ...
                            throw (
                                "Twine error: Unable to create function on " +
                                i.nodeName +
                    ...
                    I = function (t) {
                        return /\$registry/.test(t);
                    },
                    x = function (t) {
                        var e;
                        return (
                            null != t.bindingId &&
                            (null != (e = l[t.bindingId]) ? e.indexes : void 0)
                        );
                    },
                    e = function (t, e) {
                        var i, n, o, s;
                        if (!(n = x(t))) return {};
                        for (o in ((s = {}), n)) (i = n[o]), (s[o] = e[o][i]);
                        return s;
                    },
                    g = function (t) {
                        return (
                    ...
                    t.bindingTypes = {
                        bind: function (i, n, o) {
                            var s, r, a, l, c, u, h, f, m, v, y;
                            return (
                                (y = R(i)),
                                (v = i[y]),
                                (c = void 0),
                                (f = void 0),
                                (r = "radio" === i.getAttribute("type")),
                                (a = U(o, "$context,$root,$arrayPointers", i)),
                                (u = function () {
                                    var t;
                                    if (
                                        (t = a.call(i, n, P, e(i, n))) !== c &&
                                        ((c = t), t !== i[y])
                                    )
                                        return (
                                            (i[y] = r ? t === i.value : t), d(i)
                                        );
                                }),
                                g(o)
                                    ? ((h = function () {
                                      ...
                                      m &&
                                          ...
                                          jQuery(i).on("input keyup change", s),
                                          (f = function () {
                                              return jQuery(i).off(
                                                  "input keyup change",
                                                  s
                                      ...
                                      { refresh: u, teardown: f })
                                    : { refresh: u }
                            );
                        },
                        "bind-show": function (t, i, n) {
                            var o, s;
                            return (
                                (o = U(n, "$context,$root,$arrayPointers", t)),
                                (s = void 0),
                                {
                                    refresh: function () {
                                        var n;
                                        if (
                                            (n = !o.call(t, i, P, e(t, i))) !==
                                            s
                                        )
                                            return jQuery(t).toggleClass(
                                                "hide",
                                                (s = n)
                                            );
                                    },
                        ...
                        "bind-class": function (t, i, n) {
                            var o, s, r;
                            return (
                                (s = U(n, "$context,$root,$arrayPointers", t)),
                                (r = {}),
                                (o = jQuery(t)),
                                {
                                    refresh: function () {
                                        ...
                                        return (
                                            u.length &&
                                                o.removeClass(u.join(" ")),
                                            n.length && o.addClass(n.join(" ")),
                                            (r = c)
                                        );
                                    },
                                }
                        ...
                        define: function (t, i, n) {
                            ...
                            for (o in (s = U(
                                n,
                                "$context,$root,$registry,$arrayPointers",
                                t
                            ).call(t, i, P, O, e(t, i))))
                                (r = s[o]), (i[o] = r);
                        },
                    ...
                    a = function (t, e, i) {
                        var n, o, s, r;
                        for (o in ((n = {}),
                        (s = U(i, "$context,$root", t).call(t, e, P)))) {
                            if (
                                ((r = s[o]),
                                null == e[o] && (e[o] = []),
                                ...
                                throw (
                                    "Twine error: expected '" +
                                    o +
                                    "' to be an array"
                                );
                            (n[o] = e[o].length), e[o].push(r);
                        }
                        return n;
                    },
                    q = function (i, n) {
                        ...
                        return (
                            (o =
                                ...
                                "readOnly" === i ||
                                "draggable" === i),
                            (t.bindingTypes["bind-" + n.toLowerCase()] =
                                function (t, n, s) {
                                    var r, a;
                                    return (
                                        (r = U(
                                            s,
                                            "$context,$root,$arrayPointers",
                                            t
                                        )),
                                        (a = void 0),
                                        {
            ...
            for (
                q("innerHTML", "unsafe-html"),
                    ...
                    j = function (i) {
                        return (t.bindingTypes["bind-event-" + i] = function (
                            n,
                            o,
                            s
                        ) {
                            ...
                            return (
                                (r = function (r, a) {
                                    ...
                                    if (
                                        (((c =
                                            "function" ==
                                            typeof (l = t.shouldDiscardEvent)[i]
                                                ? l[i](r)
                                                : void 0) ||
                                            S(r)) &&
                                            r.preventDefault(),
                                        ...
                                        return (
                                            U(
                                                s,
                                                "$context,$root,$arrayPointers,event,data",
                                                n
                                            ).call(n, o, P, e(n, o), r, a),
                                            t.refreshImmediately()
                                        );
                                }),
                                jQuery(n).on(i, r),
            ...
            "function" == typeof (t = this).define && t.define.amd
                ? t.define([], e)
    ...
    (function (t) {
        ...
        function e(e) {
            return this.each(function () {
                ...
                (s || "destroy" != e) &&
                    (s || i.data("bs.validator", (s = new n(this, o))),
                    "string" == typeof e && s[e]());
            });
        }
        var i = ':input:not([type="submit"], button):enabled:visible',
            n = function (e, i) {
                for (var o in ((this.$element = t(e)),
                (this.options = i),
                (i.errors = t.extend({}, n.DEFAULTS.errors, i.errors)),
                i.custom))
                    if (!i.errors[o])
                        throw new Error(
                ...
                t.extend(n.VALIDATORS, i.custom),
                    ...
                    this.$element.find("[data-match]").each(function () {
                        var e = t(this),
                            i = e.data("match");
                        t(i).on("input.bs.validator", function () {
        ...
        (n.DEFAULTS = {
            ...
            (n.prototype.validateInput = function (e) {
                ...
                if (
                    ...
                    this.$element.trigger(
                        (e = t.Event("validate.bs.validator", {
                            relatedTarget: i[0],
                        }))
                    ),
                    !e.isDefaultPrevented())
                    ...
                    this.runValidators(i).done(function (s) {
                        i.data("bs.validator.errors", s),
                            s.length ? o.showErrors(i) : o.clearErrors(i),
                            (n && s.toString() === n.toString()) ||
                                ((e = s.length
            ...
            (n.prototype.runValidators = function (e) {
                function i(t) {
                    return (
                        e.data(t + "-error") ||
                        e.data("error") ||
                        ("native" == t && e[0].validationMessage) ||
                        r.errors[t]
                    );
                }
                var o = [],
                    ...
                    r = this.options;
                return (
                    e.data("bs.validator.deferred") &&
                        e.data("bs.validator.deferred").reject(),
                    e.data("bs.validator.deferred", s),
                    t.each(
                        n.VALIDATORS,
            ...
            (n.prototype.validate = function () {
                ...
                return (
                    ...
                    this.$element.find(i).trigger("input.bs.validator"),
            ...
            (n.prototype.clearErrors = function (t) {
                ...
                i.html(i.data("bs.validator.originalContent")),
                    ...
                    n.length &&
                        n.removeClass(this.options.feedback.error) &&
                        n.addClass(this.options.feedback.success) &&
                        e.addClass("has-success");
            }),
            (n.prototype.hasErrors = function () {
                return !!this.$element.find(i).filter(function () {
                ...
                return !!this.$element
                    ...
                    .filter(function () {
                        return "checkbox" === this.type
                            ? !this.checked
                            : "radio" === this.type
                            ? !t('[name="' + this.name + '"]:checked').length
                            : "" === t.trim(this.value);
                    }).length;
            }),
            ...
            (n.prototype.toggleSubmit = function () {
                this.options.disable &&
                    t('button[type="submit"], input[type="submit"]')
                    ...
                    this.options.delay
                        ? (window.clearTimeout(e.data("bs.validator.timeout")),
                          void e.data(
                              ...
                              window.setTimeout(i, this.options.delay)
                          ))
                        : i()
                );
            }),
                ...
                return (
                    ...
                    this.$element
                        ...
                        .each(function () {
                            ...
                            e.removeData("bs.validator.originalContent").html(
                                i
                            );
                        }),
                    this.$element
    ...
    (function (t, e) {
        ...
        (i.configure = function (t) {
            var e, i;
            for (e in t)
                void 0 !== (i = t[e]) && t.hasOwnProperty(e) && (n[e] = i);
            return this;
        }),
            (i.status = null),
            (i.set = function (t) {
                ...
                return (
                    ...
                    r(function (e) {
                        "" === n.positionUsing &&
                            (n.positionUsing = i.getPositioningCSS()),
                            a(
                                c,
                                (function (t, e, i) {
                                    var o;
...
var AMOUNT_NO_DECIMALS_WITH_COMMA_SEPARATOR =
        "{{amount_no_decimals_with_comma_separator}}",
    AMOUNT = "{{amount}}",
    AMOUNT_NO_DECIMAL = "{{amount_no_decimals}}";
function money(t, e) {
    if (
        ((e = "<span>" + e + "</span>"), (e = $(e).text()).indexOf(AMOUNT) > -1)
    ) {
        var i = e.replace(AMOUNT, "{0}"),
            n = convertDecimalToMoneyString(t, AMOUNT);
        return i.format(n);
    }
    if (e.indexOf(AMOUNT_NO_DECIMAL) > -1) {
        (i = e.replace(AMOUNT_NO_DECIMAL, "{0}")),
            (n = convertDecimalToMoneyString(t, AMOUNT_NO_DECIMAL));
        return i.format(n);
    }
    if (e.indexOf(AMOUNT_NO_DECIMALS_WITH_COMMA_SEPARATOR) > -1) {
        (i = e.replace(AMOUNT_NO_DECIMALS_WITH_COMMA_SEPARATOR, "{0}")),
            (n = convertDecimalToMoneyString(
                t,
                AMOUNT_NO_DECIMALS_WITH_COMMA_SEPARATOR
            ));
        return i.format(n);
...
function convertDecimalToMoneyString(t, e) {
    return e === AMOUNT
        ? t.formatMoney(2, ".", ",")
        : e === AMOUNT_NO_DECIMAL
        ? t.formatMoney(0, ".", ",")
        : e === AMOUNT_NO_DECIMALS_WITH_COMMA_SEPARATOR
        ? t.formatMoney(0, ",", ".")
        : void 0;
}
String.prototype.format ||
        ...
        (Number.prototype.formatMoney = function (t, e, i) {
            var n = this,
                o =
                    ...
                    (i = null == i ? "," : i),
                    n < 0 ? "-" : ""),
                s = parseInt((n = Math.abs(+n || 0).toFixed(t))) + "",
                r = (r = s.length) > 3 ? r % 3 : 0;
            return (
                o +
                (r ? s.substr(0, r) + i : "") +
                s.substr(r).replace(/(\d{3})(?=\d)/g, "$1" + i) +
                (t
                    ? e +
                      Math.abs(n - s)
                          .toFixed(t)
                ...
                return (
                    ...
                    e.define("select2/utils", ["jquery"], function (t) {
                        ...
                        return (
                            ...
                            (i.StoreData = function (t, e, n) {
                                ...
                                i.__cache[o] || (i.__cache[o] = {}),
                                    (i.__cache[o][e] = n);
                            }),
                            (i.GetData = function (e, n) {
                                var o = i.GetUniqueElementId(e);
                                return n
                                    ? i.__cache[o] && null != i.__cache[o][n]
                                        ? i.__cache[o][n]
                                        : t(e).data(n)
                                    : i.__cache[o];
                            }),
                    ...
                    e.define(
                        ...
                        function (t, e) {
                            ...
                            return (
                                ...
                                (i.prototype.getHighlightedResults =
                                    function () {
                                ...
                                (i.prototype.ensureHighlightVisible =
                                    function () {
                    ...
                    e.define(
                        ...
                        function (t, e, i) {
                            ...
                            return (
                                ...
                                (n.prototype._attachCloseHandler = function (
                                    i
                                ) {
                                    t(document.body).on(
                                        "mousedown.select2." + i.id,
                                        function (i) {
                                            var n = t(i.target).closest(
                                                ".select2"
                                            );
                                            t(
                                ...
                                (n.prototype._detachCloseHandler = function (
                                    e
                                ) {
                                    t(document.body).off(
                        ...
                        function (t) {
                            ...
                            return (
                                ...
                                (e.prototype.update = function (t, e) {
                                    var i =
                                        1 == e.length &&
                                        e[0].id != this.placeholder.id;
                                    if (e.length > 1 || i)
                                        return t.call(this, e);
                                    this.clear();
                                    var n = this.createPlaceholder(
                                        this.placeholder
                                    );
                                    this.$selection
                                        .find(".select2-selection__rendered")
                    ...
                    e.define(
                        ...
                        function (t, e, i) {
                            ...
                            return (
                                ...
                                (n.prototype._handleKeyboardClear = function (
                                    t,
                                    i,
                                    n
                                ) {
                    ...
                    e.define(
                        ...
                        function (t, e, i) {
                            ...
                            return (
                                ...
                                (n.prototype.createPlaceholder = function (
                                    t,
                                    e
                                ) {
                        ...
                        function (t, e, i) {
                            ...
                            return (
                                ...
                                (n.prototype.item = function (t) {
                                    ...
                                    return (
                                        ((n = this._normalizeItem(n)).element =
                                            t[0]),
                                        e.StoreData(t[0], "data", n),
                                        n
                                    );
                                }),
                        ...
                        function (t, e, i) {
                            ...
                            return (
                                ...
                                (n.prototype.query = function (t, e) {
                                    ...
                                    var o = this;
                                    null != this._request &&
                                        (i.isFunction(this._request.abort) &&
                                            this._request.abort(),
                                        (this._request = null));
                                    var s = i.extend(
                                        { type: "GET" },
                        ...
                        function () {
                            ...
                            return (
                                (t.prototype.append = function (t, e) {
                                    (e.results = this.removePlaceholder(
                                        e.results
                                    )),
                                        t.call(this, e);
                                }),
                                ...
                                (t.prototype.removePlaceholder = function (
                                    ...
                                    for (
                                        var i = e.slice(0), n = e.length - 1;
                                        n >= 0;
                                        n--
                                    ) {
                                        var o = e[n];
                                        this.placeholder.id === o.id &&
                                            i.splice(n, 1);
                                    }
                                    return i;
                                }),
                                        ...
                                        this.$results.on("scroll", function () {
                                            ...
                                            !o.loading &&
                                                ...
                                                o.$results.offset().top +
                                                    ...
                                                    50 >=
                                                    o.$loadingMore.offset()
                                                        .top +
                                                        o.$loadingMore.outerHeight(
                                                            !1
                                                        ) &&
                                                o.loadMore();
                                        });
                    ...
                    e.define(
                        ...
                        function (t, e) {
                            ...
                            return (
                                ...
                                (i.prototype._attachPositioningHandler =
                                    function (i, n) {
                                        var o = this,
                                ...
                                (i.prototype._detachPositioningHandler =
                                    function (i, n) {
                                ...
                                (i.prototype._positionDropdown = function () {
                                    ...
                                    s.bottom =
                                        s.top + this.$container.outerHeight(!1);
                                    var r = {
                                        height: this.$container.outerHeight(!1),
                                    };
                                    (r.top = s.top),
                                        (r.bottom = s.top + r.height);
                        ...
                        function (t, e, i, n) {
                            function o(e, o) {
                                if (
                                    ...
                                    this.options.dataAdapter = n.Decorate(
                                ...
                                (o.prototype.fromElement = function (t) {
                                    ...
                                    o =
                                        ...
                                        t[0].dataset
                                            ...
                                            : n.GetData(t[0]);
                                    var s = e.extend(!0, {}, o);
                                    for (var r in (s = n._convertData(s)))
                                        e.inArray(r, i) > -1 ||
                                            (e.isPlainObject(this.options[r])
                                                ? e.extend(
                                                      this.options[r],
                                                      s[r]
                                                  )
                    ...
                    e.define(
                        ...
                        function (t, e, i, n) {
                            var o = function (t, n) {
                                ...
                                i.StoreData(t[0], "old-tabindex", s),
                                    t.attr("tabindex", "-1");
                            ...
                            return (
                                ...
                                (o.prototype._registerSelectionEvents =
                                    function () {
                                        var e = this,
                                            i = ["toggle", "focus"];
                                        this.selection.on(
                                ...
                                (o.prototype._registerResultsEvents =
                                    function () {
                                        var t = this;
                            ...
                            return (
                                (n.prototype.render = function (n) {
                                    ...
                                    return (
                                        t.isFunction(l) &&
                                            (l = l(this.$element)),
                                        e.syncCssClasses(o, this.$element, r),
                                        o.css(l),
                                        o.addClass(s),
                                        o
                                    );
                    ...
                    e.define(
                        ...
                        function (t) {
                            ...
                            return (
                                (e.prototype.current = function (e, i) {
                                    var n = this;
                                    this._isInitialized
                                        ? e.call(this, i)
                    ...
                    e.define(
                        ...
                        function (t, e) {
                            ...
                            return (
                                (i.prototype.current = function (e, i) {
                                    function n(e, i) {
                                        var o = [];
                                        return (
                                            e.selected ||
                                            -1 !== t.inArray(e.id, i)
                                                ? ((e.selected = !0), o.push(e))
                                                : (e.selected = !1),
                                            e.children &&
                                                o.push.apply(
                                                    o,
                                ...
                                (i.prototype.unselect = function (t, e) {
                                    var i = this;
                                    (e.selected = !1),
                                        this.current(function (t) {
                                            ...
                                            i.$element.val(
                                                n.join(i._valueSeparator)
                                            ),
                                                i.$element.trigger("change");
                                        });
                                }),
                                (i.prototype.query = function (t, e, i) {
                                    for (
                                        var n = [], o = 0;
                    ...
                    e.define(
                        ...
                        function (t) {
                            return function (e) {
                                return function (i, n) {
                                    var o = t.extend(!0, {}, n);
                                    if (null == i.term || "" === t.trim(i.term))
                                        return o;
                                    if (n.children) {
                                        for (
                                            var s = n.children.length - 1;
                                            s >= 0;
                                            s--
                                        ) {
                                            var r = n.children[s];
                    ...
                    e.define("select2/compat/query", [], function () {
                        ...
                        return (
                            (t.prototype.query = function (t, e, i) {
                                (e.callback = i),
                                    this.options.get("query").call(null, e);
                            }),
                            t
                        );
                    }),
                        ...
                        function () {
                            ...
                            return (
                                (t.prototype.position = function (t, e, i) {
                                    i.find(".dropdown-wrapper").append(e),
                                        e.addClass("select2-dropdown--below"),
                    ...
                    (function (i) {
                        "function" == typeof e.define && e.define.amd
                            ? e.define("jquery-mousewheel", ["jquery"], i)
                            : "object" == typeof exports
                            ? (module.exports = i)
                            : i(t);
                    })(function (t) {
                        function e(e) {
                            ...
                            if (
                                ...
                                return (
                                    ...
                                    o && clearTimeout(o),
                                    (o = setTimeout(i, 200)),
                                    (t.event.dispatch || t.event.handle).apply(
                                        this,
                                        a
                                    )
                                );
                        ...
                        if (t.event.fixHooks)
                            for (var c = r.length; c; )
                                t.event.fixHooks[r[--c]] = t.event.mouseHooks;
                        var d = (t.event.special.mousewheel = {
                            ...
                            setup: function () {
                                ...
                                t.data(
                                    this,
                                    "mousewheel-line-height",
                                    d.getLineHeight(this)
                                ),
                                    t.data(
                                        this,
                                        "mousewheel-page-height",
                                        d.getPageHeight(this)
                                    );
                            },
                            teardown: function () {
    ...
    (function (t, e) {
        ...
        var i = "function",
            ...
            v = {
                rgx: function (t, n) {
                    for (var s, r, a, l, c, d, u = 0; u < n.length && !c; ) {
                        var h = n[u],
                            p = n[u + 1];
                        for (s = r = 0; s < h.length && !c; )
                            if ((c = h[s++].exec(t)))
                                for (a = 0; a < p.length; a++)
                                    (d = c[++r]),
                                        typeof (l = p[a]) === o && l.length > 0
                                            ? 2 == l.length
                                                ? typeof l[1] == i
                                                    ? (this[l[0]] = l[1].call(
                                                          this,
                ...
                str: function (t, i) {
                    for (var n in i)
                        if (typeof i[n] === o && i[n].length > 0) {
                            for (var s = 0; s < i[n].length; s++)
                                if (m.has(i[n][s], t)) return "?" === n ? e : n;
                        } else if (m.has(i[n], t)) return "?" === n ? e : n;
                    return t;
                },
            },
            y = {
            ...
            b = {
                browser: [
                    ...
                    [r, [c, v.str, y.browser.oldsafari.version]],
                ...
                os: [
                    ...
                    [r, [c, v.str, y.os.windows.version]],
                    [/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],
                    [
                        [r, "Windows"],
                        [c, v.str, y.os.windows.version],
                    ],
                    [/\((bb)(10);/i],
                    [[r, "BlackBerry"], c],
                    [
            ...
            w = function (i, n) {
                if (
                    ("object" == typeof i && ((n = i), (i = e)),
                    !(this instanceof w))
                )
                    return new w(i, n).getResult();
                var o =
                        i ||
                ...
                return (
                    ...
                    (this.getCPU = function () {
                        ...
                        return v.rgx.call(t, o, s.cpu), t;
                    }),
                    (this.getDevice = function () {
                        var t = { vendor: e, model: e, type: e };
                        return v.rgx.call(t, o, s.device), t;
                    }),
                    (this.getEngine = function () {
                        var t = { name: e, version: e };
                        return v.rgx.call(t, o, s.engine), t;
                    }),
                    (this.getOS = function () {
                        var t = { name: e, version: e };
                        return v.rgx.call(t, o, s.os), t;
                    }),
        ...
        (w.VERSION = "0.7.18"),
            (w.BROWSER = { NAME: r, MAJOR: "major", VERSION: c }),
            (w.CPU = { ARCHITECTURE: d }),
            (w.DEVICE = {
                MODEL: s,
                VENDOR: l,
                TYPE: a,
            ...
            (w.ENGINE = { NAME: r, VERSION: c }),
            (w.OS = { NAME: r, VERSION: c }),
            typeof exports !== n
                ? (typeof module !== n &&
                      module.exports &&
