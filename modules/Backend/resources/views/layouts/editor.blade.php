...
<body class="mojar__menuLeft--dark mojar__menuLeft--unfixed mojar__menuLeft--shadow">
    ...
    <div class="page">
        <!-- Navbar -->
        <header class="navbar navbar-expand-md sticky-top d-none d-lg-flex d-print-none mojar_cms_topbar"
            data-bs-theme="{{ session('theme') }}">
            @include('cms::backend.menu_top')
        </header>
        <!-- Sidebar -->
        <div class="d-block d-lg-flex">
            <aside class="navbar navbar-vertical navbar-expand-lg mojar_cms_sidebar"
                data-bs-theme="{{ session('theme') }}">
                <div class="container-xl">
                    ...
                    <h1 class="navbar-brand navbar-brand-autodark">
                        <a href="/{{ config('mojar.admin_prefix') }}" class="d-lg-none d-block">
                            ...
                            @else
                                <img src="{{ asset('jw-styles/mojar/assets/static/logo.png') }}" width="110"
                ...
                <div class="page-body">
                    <div class="container-xl">
                        ...
                        @if (session()->has('message'))
                            <div class="alert alert-{{ session()->get('status') == 'error' ? 'danger' : 'success' }} alert-dismissible jw-message"
                                role="alert">
                                <div class="d-flex">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon alert-icon" width="24"
