            ...
            <div class="modal-body">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="upload" role="tabpanel" aria-labelledby="upload-tab">
                        <form 
                            action="{{ route('filemanager.upload') }}" 
                            role="form" 
                            id="uploadForm"
                            name="uploadForm" 
                            method="post" 
                    ...
                    <div class="tab-pane fade" id="import" role="tabpanel" aria-labelledby="import-tab">
                        <form 
                            action="{{ route('filemanager.import') }}" 
                            role="form" 
                            method="post" 
                            class="form-ajax"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="upload-modal-label">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        @if (config('mojar.filemanager.upload_from_url'))
                            <li class="nav-item">
                                <a class="nav-link text-capitalize" id="import-tab" data-toggle="tab" href="#import"
            ...
            <div class="modal-body">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="import" role="tabpanel" aria-labelledby="import-tab">
                        <form action="{{ route('filemanager.import') }}" role="form" method="post" class="form-ajax"
                            data-success="add_folder_success">
