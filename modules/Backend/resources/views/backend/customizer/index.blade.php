...
<head>
    <link rel="shortcut icon" href="{{ asset('jw-styles/mojar/images/brand/favicon.ico') }}">
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('jw-styles/mojar/css/theme-editor.css') }}">
    <!--[if lt IE 9]>
    <script src="{{ asset('jw-styles/mojar/js/html5shiv.min.js') }}"></script>
    <script src="{{ asset('jw-styles/mojar/js/respond.min.js') }}"></script>
    <![endif]-->

    <script src="{{ asset('jw-styles/mojar/js/theme-editor.js') }}"></script>
...
<body class="body-theme-editor theme-editor sfe-next fresh-ui next-ui" id="theme-editor"
    ...
    <div class="ui-flash-container">
        <div class="ui-flash-wrapper" id="UIFlashWrapper">
            <div class="ui-flash ui-flash--nav-offset" id="UIFlashMessage">
                <p class="ui-flash__message"></p>
                <div class='ui-flash__close-button'><button
                        class='ui-button ui-button--transparent ui-button--icon-only ui-button-flash-close'
                        aria-label='Close message' type='button' name='button'><svg
                            class='next-icon next-icon--color-white next-icon--size-12'>
                            <use xmlns:xlink='http://www.w3.org/1999/xlink' xlink:href='#next-remove'><svg
                                    id='next-remove' width='100%' height='100%'><svg
    ...
    <main class="theme-editor__wrapper" component="UI.Progress"
        define="{editorThemeV2: new Mojar.ThemeSettingsV2(this,{&quot;current_section&quot;:-1,&quot;id&quot;:731236})}"
        context="editorThemeV2">
        <div class="notifications">
            <div class="ajax-notification"><span class="ajax-notification-message"></span><a class="close-notification"
                    onclick="Mojar.Flash.hide()"><i class="fa fa-times"></i></a></div>
        </div>
        <script type="text/javascript">
            Page(function() {
                $(document).on("click", Mojar.SingleDropdown.checkFocus);
                document.addEventListener('page:before-replace', function() {
                    $(document).off("click", Mojar.SingleDropdown.checkFocus);
                }, {
                    once: true
                });
            });
                    ...
                    <div class="te-top-bar__list">
                        <div class="te-top-bar__item te-top-bar__item--fill">
                            <button class="ui-button btn--plain te-panel__header-action"
                                ...
                                <svg
                                    class="next-icon next-icon--size-20 next-icon--rotate-180 te-panel__header-action-icon">
