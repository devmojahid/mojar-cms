<div class="container-xl">
    ...
    <div class="navbar-nav flex-row order-md-last">
        ...
        <div class="d-none d-md-flex">
            <a href="javascript:void(0)" class="nav-link px-0 {{ session('theme') == 'dark' ? 'hide-theme-dark' : ''}}" title="Enable dark mode"
                data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-theme-value="dark">
            ...
            <a href="javascript:void(0)" class="nav-link px-0 {{ session('theme') == 'light' ? 'hide-theme-light' : ''}}" title="Enable light mode"
                data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-theme-value="light">
