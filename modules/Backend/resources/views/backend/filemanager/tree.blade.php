<div class="m-3 d-block d-lg-none">
    ...
    <div class="row mt-3">
        <div class="col-4">
            <img src="{{ asset('jw-styles/mojar/images/logo.png') }}" class="w-100" alt="Mojar logo" />
        </div>
    ...
    <div class="progress mt-3" style="height: .5rem;">
        <div class="progress-bar progress-bar-striped progress-bar-animated bg-main" role="progressbar"
            aria-valuenow="{{ round($storage / $total, 2) }}" aria-valuemin="0" aria-valuemax="100"
            style="width: {{ round($storage / $total, 2) }}%;"></div>
    </div>
</div>
