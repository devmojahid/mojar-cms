...
@section('content')
                ...
                <table class="table mojar-table">
                    <thead>
                        <tr>
                            ...
                            <th data-field="status" data-width="10%" data-formatter="status_formatter">
    ...
    <script type="text/javascript">
        function status_formatter(value, row, index) {
            switch (value) {
                case 'installed':
                    return `<span class="text-success">${mojar.lang.installed}</span>`;
            }

            return `<span class="text-secondary">${mojar.lang.not_installed}</span>`;
        }
