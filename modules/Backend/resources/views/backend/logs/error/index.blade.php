...
@section('content')
        ...
        <table class="table mojar-table">
            <thead>
                <tr>
                    ...
                    <th data-width="15%" data-align="center" data-formatter="action_formatter">
                        {{ trans('cms::app.actions') }}</th>
                </tr>
            </thead>
        </table>
    </div>
    ...
    <script type="text/javascript">
        function action_formatter(value, row, index) {
            ...
            str +=
                `<a href="javascript:void(0)" class="btn btn-danger px-2 delete-log" data-date="${row.date}"><i class="fa fa-trash"></i></a>`;
            return str;
        }
        ...
        $(document).on('click', '.delete-log', function() {
            ...
            confirm_message(
                "{{ trans('Are you sure you want to delete this log file: :date ?', ['date' => '__DATE__']) }}"
