                    ...
                    <div class="col-lg">
                        <div class="container-tight">
                                    ...
                                    <form action="{{ route('register') }}" method="post" class="form-ajax">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                placeholder="{{ trans('cms::app.full_name') }}" autocomplete="off"
                                                required />
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-flat password-toggle-group">
                            ...
                            <div class="text-center text-secondary mt-3">
                                {{ __('Already have an account?') }} <a href="{{ route('admin.login') }}"
                                    class="text-decoration-none">{{ __('Sign in') }}</a>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Select all password toggle groups
            document.querySelectorAll('.password-toggle-group').forEach(group => {
                const button = group.querySelector('.password-toggle-button');
