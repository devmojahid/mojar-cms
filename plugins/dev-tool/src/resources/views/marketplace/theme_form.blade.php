    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" 
                        action="{{ $model->id ? route('admin.dev-tool.marketplace-themes.update', $model->id) : route('admin.dev-tool.marketplace-themes.store') }}" 
                        class="form-ajax"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group mb-4">
                                    <label class="col-form-label">{{ trans('Theme Package') }}</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="form-text text-muted">{{ __('External URL where the theme package can be downloaded from. Leave empty to use local file.') }}</small>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @endif
                                        <small class="form-text text-muted">{{ __('ZIP file containing the theme package. Only required if no download URL is provided.') }}</small>
                                    </div>
                                </div>
                                
                                <div class="form-group mb-4">
                                    <label class="col-form-label">{{ trans('Screenshot') }}</label>
                                    
                                    <div class="mb-3">
                                        <label class="col-form-label" for="screenshot">{{ trans('Screenshot URL') }}</label>
                                        <input type="url" class="form-control" id="screenshot" name="screenshot" value="{{ $model->screenshot }}">
                                        <small class="form-text text-muted">{{ __('External URL for the screenshot image. Leave empty to use local file.') }}</small>
                                    </div>
                                    
                                    <div>
                                        <label class="col-form-label" for="screenshot_file">{{ trans('Upload Screenshot') }}</label>
                                        <input type="file" class="form-control" id="screenshot_file" name="screenshot_file" accept="image/*">
                                        @if($model->screenshot_path)
                                            <div class="mt-2">
                                                <span class="badge bg-success">{{ __('Current file:') }} {{ basename($model->screenshot_path) }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="mt-3">
                            ...
                            <a href="{{ route('admin.dev-tool.marketplace-themes.index') }}" class="btn btn-secondary">
