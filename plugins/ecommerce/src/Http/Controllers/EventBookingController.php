...
class EventBookingController extends BackendController
{
    ...
    protected string $viewPrefix = 'ecomm::backend.event-booking';
    ...
    protected function getDataForForm($model, ...$params): array
    {
        ...
        $data['statuses'] = [
            EventBooking::PAYMENT_STATUS_COMPLETED => trans('ecomm::content.completed'),
            EventBooking::PAYMENT_STATUS_PENDING => trans('ecomm::content.pending')
        ];
        return $data;
    ...
    {
        return trans('ecomm::content.event_bookings');
    }
