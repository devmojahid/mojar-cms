...
(function($) {
    ...
    Juzaweb.StoreCheckout.prototype = {
        ...
        submitCheckout: function() {
            ...
            $.ajax({
                url: window.lmsConfig.routes.checkout,
                method: 'POST',
                data: $form.serialize(),
                ...
                error: function(xhr) {
                    ...
                    $submitButton.prop('disabled', false)
                                .val(Juzaweb.trans('lms::content.order'));
        ...
        calculateShipping: function() {
            ...
            $.ajax({
                url: window.lmsConfig.routes.update,
                method: 'POST',
                data: {
                    _token: window.lmsConfig.csrf_token,
...
(function($) {
    ...
    $(document).ready(function() {
        new Checkout("#checkout-form", {
            buttonText: "{{ trans('lms::content.place_order') }}"
        });
    });
})(jQuery);
